...
class FashionStoresWithProductsAdapter(options: FirestoreRecyclerOptions<Store>, context: Context) :
    FirestoreRecyclerAdapter<Store, FashionStoresWithProductsAdapter.StoreViewHolder>(options) {
